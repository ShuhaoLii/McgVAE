...
def arguments():
    ...
    parser.add_argument ('--dataset_dir', type=str, default='./Datasets/PEMS_lane43_v2', help='')
    parser.add_argument ('--dataset_name', type=str, choices=['HuaNan', 'PEMS'], default="PEMS", help='')
    parser.add_argument ('--batch_size', type=int, default=64, help='batch size')
    parser.add_argument ('--horizon', type=int, default=6)
    parser.add_argument ('--seq_len', type=int, default=12, help='')
    parser.add_argument ('--input_dim', type=int, default=1)
    parser.add_argument ('--output_dim', type=int, default=1)
    parser.add_argument ('--lane_num_nodes', type=int, default=43)
    parser.add_argument ('--road_num_nodes', type=int, choices=[8, 18], default=8,help='PeMS:8,HuaNan:18')
    parser.add_argument ('--road_lane_count',  default=[5, 6, 5, 6, 5, 6, 5, 5], help='pems43 [5, 6, 5, 6, 5, 6, 5, 5],pems40 [5,5,5,5,5,5,5,5],huanan [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]')
    parser.add_argument ('--Correlation_threshold', type=int,default=25, help='')
    ...
    parser.add_argument ('--isMissing', type=bool, default=True, help='Whether to mask the true value in the training data')
    parser.add_argument ('--Missing_ratio', type=float, default=0.01, help='Random mask ratio')
